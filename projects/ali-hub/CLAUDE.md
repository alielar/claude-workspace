...
> Last updated: 2026-09-14 (widget counts + lock-screen order, doc→task, UI audit, growing checklist boxes, routine dedupe + editable checklist, Mobility two sessions, podcast last-3 + deeper script). Read `ALI_SPEC.md` first — it is the product brief and phase plan. This file is the engineering map.

...
src/app/(app)/stretch     guided stretching timer (22 moves in 4 blocks, per-move 20-50s + 10s rests, 14:40, wake lock, voice + beeps; renames stored by move key, never by position)

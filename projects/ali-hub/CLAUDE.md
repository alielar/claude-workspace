...
> Last updated: 2026-09-12 (night: Mobility 12:00, editable channels, doc formats + subtasks, encrypted password vault). Read `ALI_SPEC.md` first — it is the product brief and phase plan. This file is the engineering map.

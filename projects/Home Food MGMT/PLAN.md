...
- [ ] 🟨 **Step 2: Meal library** (built and live, family review of the Darija still open)
  ...
  - [x] 🟩 MyPlate high-protein batch (2026-09-20): 30 dishes adapted from the public-domain USDA recipes, photos sourced separately under free licence and reviewed by eye, American store-cupboard items swapped for what is sold in Morocco. Catalog is now 269 dishes, all with a photo.

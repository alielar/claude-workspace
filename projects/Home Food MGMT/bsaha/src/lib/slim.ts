...
export function toSlim(d: Dish): SlimDish {
  return {
    ...
    cuisine: d.cuisine, inMain: d.inMain, lean: d.isLean, onMenu: d.onMenu, tags: d.tags ?? [],
...
export async function listSlimDishes(): Promise<SlimDish[]> {
  ...
  const rows = await db
    .select({
      ...
      cuisine: dishes.cuisine, inMain: dishes.inMain, isLean: dishes.isLean, onMenu: dishes.onMenu, tags: dishes.tags, macros: dishes.macros,

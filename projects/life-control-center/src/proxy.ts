...
const PUBLIC_PREFIXES = ["/login", "/api/auth/", "/offline", "/api/reminders/tick", "/api/news/cron", "/api/checklist/suggestions/cron", "/api/workouts/coach-cron", "/api/sleep/ingest", "/api/wati"];
